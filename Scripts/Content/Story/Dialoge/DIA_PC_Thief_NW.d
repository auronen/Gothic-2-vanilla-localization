...
func void DIA_DiegoNW_NeedHelp_Problem_WillHelpYou()
{
	...
	AI_Output(self,other,"DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_11_01");	//Ich habe im Minental einen kleinen Schatz versteckt.
	AI_Output(self,other,"DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_11_02");	//Eigentlich wollte ich ihn ja holen, aber leider tummeln sich einige Orks bei dem Versteck rum.
...
func void DIA_DiegoNW_HelpYou_Info()
{
	...
	AI_Output(other,self,"DIA_DiegoNW_HelpYou_15_04");	//Wieso holst du ihn nicht selbst?
	AI_Output(self,other,"DIA_DiegoNW_HelpYou_11_05");	//Weil sich am Versteck ein paar Orks rumtreiben. Du bist genau der Richtige für diese Aufgabe, glaube mir.
	...
	Info_AddChoice(DIA_DiegoNW_HelpYou,"Was hast du mit dem Gold vor?",DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_YourPlan);
	Info_AddChoice(DIA_DiegoNW_HelpYou,"Wo hast du das ganze Gold her?",DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_HowGold);
	Info_AddChoice(DIA_DiegoNW_HelpYou,"Wo ist das Gold versteckt?",DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_WhereGold);
};
