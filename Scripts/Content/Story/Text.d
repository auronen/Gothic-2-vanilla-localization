...
const string MOBNAME_BOOKSTAND = "Buchständer";
const string MOBNAME_BOOKSBOARD = "Buchkommode";
...
const string MOBNAME_STOVE = "Herd";
const string MOBNAME_INNOS = "Innos Statue";
const string MOBNAME_RUNEMAKER = "Runentisch";
const string MOBNAME_SAW = "Baumsäge";
...
const string NAME_ItMw_1H_Common_01 = "Selbstgeschmiedetes Schwert";
...
const string PRINT_Learn1H_and_2H = "Verbessere: Kampf mit Einhand- und Zweihandwaffen";
const string PRINT_Learn2H = "Verbessere: Kampf mit Zweihandwaffen";
const string PRINT_Learn2H_and_1H = "Verbessere: Kampf mit Zweihand- und Einhandwaffen";
...
const string PRINT_BlessSTR = "Innos erhört dich und schenkt dir: Stärke + ";
const string PRINT_BlessDEX = "Innos erhört dich und schenkt dir: Geschicklichkeit + ";
const string PRINT_BlessMANA_MAX = "Innos erhört dich und schenkt dir: Mana + ";
const string PRINT_BlessHitpoints_MAX = "Innos erhört dich und schenkt dir: Lebensenergie + ";
const string PRINT_BlessMANA = "Innos erhört dich und du bist erfüllt von geistiger Klarheit.";
const string PRINT_BlessHitpoints = "Innos erhört dich und heilt dich.";
const string Print_BlessMana_Hit = "Innos erhört dich du fühlst dich wie neugeboren.";
const string Print_BlessNone = "Innos dankt für dein Gebet.";
const string Print_NotEnoughGold = "Zuwenig Gold.";
...
const string PRINT_STR1 = "Stärke +1";
const string PRINT_MANA10 = "Mana +10";
const string PRINT_DEX2 = "Geschicklichkeit + 2";
...
const string PRINT_XPGained = "Erfahrung + ";
const string PRINT_LevelUp = "Stufe gestiegen!";
